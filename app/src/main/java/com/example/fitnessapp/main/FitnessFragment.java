...
public class FitnessFragment extends Fragment {
    ...
    //layouts
    private ConstraintLayout mainDay;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mainDay = v.findViewById(R.id.fitness_main_ex_layout);


        mainDay.setAnimation(AnimationUtils.loadAnimation(getContext(),R.anim.enter_bottom_to_top));
